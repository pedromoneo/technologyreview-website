        ...
        return (
            <div className="min-h-screen pt-40 pb-20 flex items-center justify-center px-6">
                <div className="max-w-md w-full text-center">
                    ...
                    <h1 className="text-4xl font-black italic tracking-tighter mb-4">¡Bienvenido de nuevo!</h1>
                    <p className="text-gray-500 mb-10 font-medium">
                        Has iniciado sesión como <span className="text-primary font-bold">{user.email}</span>.
                    </p>
                    <Link
                        href="/"
        ...
        <div className="min-h-screen pt-40 pb-20 flex items-center justify-center px-6 bg-gray-50 relative overflow-hidden">
            ...
            <div className="max-w-xl w-full relative z-10">
                <div className="bg-white p-12 md:p-16 shadow-2xl border-t-8 border-primary">
                    <div className="mb-12">
                        <h1 className="text-5xl md:text-6xl font-black italic tracking-tighter mb-6">Inicia Sesión.</h1>
                        <p className="text-lg text-gray-500 font-medium leading-relaxed">
                            Accede a tu cuenta de <span className="text-primary font-bold">MIT Technology Review en español</span> para continuar leyendo sin límites.
                        </p>
                    </div>
                    ...
                    {isSent ? (
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="relative flex items-center justify-center">
                                ...
                                <span className="relative bg-white px-6 text-[10px] font-black uppercase tracking-[0.3em] text-gray-400">o tu email</span>
                            </div>
                            ...
                            <form onSubmit={handleMagicLink} className="space-y-4">
                                ...
                                >
                                    {isLoading ? (
                                        ...
                                        <>
                                            Enviar enlace de acceso <ArrowRight className="ml-3 w-4 h-4 transform group-hover:translate-x-1 transition-transform" />
                                        </>
                                    )}
                                </button>
                            </form>
                ...
                <div className="mt-12 text-center">
                    <p className="text-xs font-bold text-gray-400 uppercase tracking-widest">
                        ¿No tienes cuenta? <Link href="/subscribe" className="text-primary hover:text-accent transition-colors ml-2 underline">Suscríbete aquí</Link>
                    </p>
                </div>
            </div>
        </div>
