        ...
        <div className="p-8 pb-16 space-y-8">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <div className="px-6 py-4 border-b border-gray-100 flex flex-col md:flex-row md:items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-2">
                        {["Todos", "Publicados", "Borradores"].map((tab) => (
                            <button key={tab} className={`px-4 py-2 rounded-md text-[9px] font-black uppercase tracking-widest transition-all ${tab === "Todos" ? "bg-primary text-white" : "bg-gray-50 text-gray-400 hover:bg-gray-100"
                                }`}>
                                {tab}
                            </button>
                        ))}
                ...
                <div className="px-6 py-4 bg-gray-50/50 border-t border-gray-50 flex items-center justify-between">
                    <p className="text-[9px] font-black uppercase tracking-widest text-gray-400">Total: {articles.length} artículos</p>
